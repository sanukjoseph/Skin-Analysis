...
test_req = {
    "normal": 1, "dry": 1, "oily": 1, "combination": 1,
    "acne": 1, "sensitive": 0, "fine lines": 0, "wrinkles": 0,
    "redness": 1, "dull": 0, "pore": 0, "pigmentation": 0,
    "blackheads": 1, "whiteheads": 0, "blemishes": 1,
    "dark circles": 0, "eye bags": 1, "dark spots": 0
}

headers = {"Content-Type": "application/json"}
response = requests.put(BASE + "/recommend", json=test_req, headers=headers)
print(response.json())
