      ...
      <Container maxWidth="xs" sx={{ marginTop: "2vh" }} alignitems="center" width="inherit">
        ...
        <FormControl component="fieldset" sx={{ marginTop: "3vh" }}>
          ...
          <Grid marginTop="2vh">
            ...
            <RadioGroup row name="row-radio-buttons-group" defaultValue={type} onChange={handleType} value={currType}>
              <Grid container>
                {skinTypes.map((type) => {
                  // Add key prop to the Grid item
                  return (
          ...
          <Grid marginTop="2vh">
            ...
            <RadioGroup row name="row-radio-buttons-group" onChange={handleAcne} defaultValue={acne} value={currAcne}>
              <Grid container>
                {acnes.map((ac) => {
                  // Add key prop to the Grid item
                  return (
